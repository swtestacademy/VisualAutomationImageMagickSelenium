...
public class BaseTest {
    ...
    public String url = "https://www.kariyer.net";
...
//                .takeScreenshot(driver,element);
    ...
    public BufferedImage takeScreenshot2(WebElement element) throws IOException {
        ...
        FileUtils.copyFile(screenshot, actualImageFile);
    ...
    //Write
    public void writeScreenshotToFolder(BufferedImage screenshot) throws IOException {
        ImageIO.write(screenshot, "PNG", actualImageFile);
    }
    ...
    //Compare Operation
    public void doComparison(BufferedImage elementScreenShot) throws Exception {
        ...
        if (baselineImageFile.exists()) {
            ...
            ImageIO.write(elementScreenShot, "PNG", baselineImageFile);
        }
    }
